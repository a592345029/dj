...
async function downFile () {
  ...
  await downloadUrl();
  if ($.body) {
    url = 'https://cdn.jsdelivr.net/gh/a592345029/dj@main/JD_DailyBonus.js';
  } else {
...
function downloadUrl(url = 'https://cdn.jsdelivr.net/gh/a592345029/dj@main/JD_DailyBonus.js') {
